...
| Types de disques pris en charge 3+| Disques persistants équilibrés ^4^, disques persistants hautes performances (SSD) ^4^ et disques persistants standard (HDD). 
|===
Remarques :
...
| Capacité système maximale (disques + stockage objet) | 2 TO ^2^ | 10 Tio | 368 Tio | 368 Tio par licence 
...
Pour obtenir une prise en charge par région https://cloud.netapp.com/cloud-volumes-global-regions["Régions Cloud volumes Global"^] de Google Cloud, consultezla section.
